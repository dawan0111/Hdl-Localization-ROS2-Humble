...
def generate_launch_description():
    ...
    odom_child_frame_id = LaunchConfiguration('odom_child_frame_id', default='base_footprint') 
    imu_topic = LaunchConfiguration('imu_topic', default='/imu')
    globalmap_pcd = DeclareLaunchArgument('globalmap_pcd', default_value='/home/kdw/slam_ws/src/glim_ros2/test.pcd', description='Path to the global map PCD file')
